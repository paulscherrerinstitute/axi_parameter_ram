...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "RamSizeDword_g" -parent ${Configuration}
...
proc update_PARAM_VALUE.RamSizeDword_g { PARAM_VALUE.RamSizeDword_g } {
	# Procedure called to update RamSizeDword_g when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RamSizeDword_g { PARAM_VALUE.RamSizeDword_g } {
	# Procedure called to validate RamSizeDword_g
	return true
}
...
proc update_MODELPARAM_VALUE.RamSizeDword_g { MODELPARAM_VALUE.RamSizeDword_g PARAM_VALUE.RamSizeDword_g } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RamSizeDword_g}] ${MODELPARAM_VALUE.RamSizeDword_g}
}
